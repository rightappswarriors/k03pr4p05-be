    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field("getOrgCategories", {
            ...
            async resolve(_, { pageSize, query, orderBy, groupId, isActive }, ctx) {
                ...
                try {
                    ...
                    if (process.env.NODE_ENV === "development") console.error("Error getting org categories:", error);
        ...
        t.nullable.field("getOrgCategoryById", {
            ...
            async resolve(_, { id }, ctx) {
                ...
                try {
                    ...
                    if (process.env.NODE_ENV === "development") console.error("Error getting org category:", error);
        ...
        t.nonNull.list.nonNull.field("getOrgCategoryItems", {
            ...
            async resolve(_, { id }, ctx) {
                ...
                if (!orgCategory) throw new Error("Category not found or does not belong to your organization.");

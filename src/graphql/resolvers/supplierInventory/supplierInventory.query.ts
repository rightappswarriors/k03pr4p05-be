import { extendType, nonNull, stringArg, intArg, nullable, arg, list } from 'nexus'
...
export const SupplierInventoryQuery = extendType({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field('supplierStockBatches', {
            ...
            resolve: (_, { supplierItemId, includeDepleted }, ctx) =>
                ctx.prisma.supplierStockBatch.findMany({
                    where: {
                        supplierItemId,
                        deletedAt: null,
        ...
        t.nonNull.list.nonNull.field('supplierInventoryMovements', {
            ...
            resolve: (_, { supplierItemId, page, pageSize }, ctx) =>
                ctx.prisma.supplierInventoryMovement.findMany({
        ...
        t.nonNull.list.nonNull.field('supplierItemCostHistoryList', {
            ...
            resolve: (_, { supplierItemId }, ctx) =>
                ctx.prisma.supplierItemCostHistory.findMany({
        ...
        t.field('supplierInventoryForecast', {
            ...
            resolve: (_, { supplierItemId, trailingDays }, ctx) =>
                inventoryService.getInventoryForecast(ctx.prisma, supplierItemId, trailingDays ?? 30),
        })

import { extendType, intArg, nonNull, objectType, stringArg, enumType, booleanArg, nullable } from "nexus";
    ...
    t.field("adminUsers", {
      ...
      async resolve(_root, args, ctx) {
       PAGE_PERMISSIONS.admin.view(ctx);
        ...
        const sortDir = (args.sortDirection ?? "DESC").toLowerCase() as "asc" | "desc";

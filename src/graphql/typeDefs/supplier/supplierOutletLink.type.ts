...
export const SupplierLinkWorkspace = objectType({
  ...
  definition(t) {
    t.nonNull.string('id'); t.nonNull.int('supplierOrgId'); t.nonNull.int('outletId');
    t.nonNull.field('status', { type: 'SupplierLinkStatus' }); t.nonNull.boolean('isApproved');
    t.nullable.string('assignedAgentName'); t.nullable.string('preferredWarehouseId');
    t.nullable.string('deliveryInstructions'); t.nullable.string('receivingHours');
    t.nullable.string('creditTerms'); t.nullable.string('notes'); t.nullable.dateTime('linkedAt');
    t.nonNull.dateTime('createdAt'); t.nonNull.dateTime('updatedAt');
    t.nonNull.string('organizationName'); t.nullable.string('organizationLogo'); t.nullable.float('rating');
    t.nonNull.float('revenue'); t.nonNull.int('orders'); t.nonNull.float('outstanding');
    t.nonNull.int('openMandates'); t.nonNull.int('unreadMessages'); t.nullable.dateTime('lastActivity');
  },
});
...
export const UpdateSupplierLinkInput = inputObjectType({
  ...
  definition(t) {
    t.nonNull.string('id'); t.nullable.field('status', { type: 'SupplierLinkStatus' });
    t.nullable.string('assignedAgentId'); t.nullable.string('preferredWarehouseId');
    t.nullable.string('deliveryInstructions'); t.nullable.string('receivingHours');
    t.nullable.string('creditTerms'); t.nullable.string('notes');
  },
});

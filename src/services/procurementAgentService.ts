...
export async function validateOrganizationInvitation(codeOrLink: string): Promise<InvitationValidation> {
  try {
...
export async function getPendingProcurementAgents(orgId: number): Promise<PendingAgent[]> {
  try {
...
export async function approveProcurementAgent(agentId: string, approverId: number) {
  try {
...
export async function rejectProcurementAgent(agentId: string, reason?: string) {
  try {
...
export async function getProcurementAgentDetails(agentId: string): Promise<AgentDetails | null> {
  try {
...
export async function getOrganizationAgents(orgId: number) {
  try {
...
export async function rejectOrganizationAgent(agentId: string, reason: string, rejectedBy: number) {
  try {

...
const worker = new Worker('restock', async (job) => {
    ...
    try {
        ...
        // Send email
        const emailContent = generateRestockEmailContent(item.name, item.stock, item.minQuantity, schedule.emailBody || undefined);

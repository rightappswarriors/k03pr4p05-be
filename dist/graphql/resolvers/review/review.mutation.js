...
import { createSupplierItemReview, deleteSupplierItemReview, updateSupplierItemReview, } from '../../../services/supplierItemReview.service.js';
import { createOrganizationReview, deleteOrganizationReview, updateOrganizationReview, } from '../../../services/organizationReview.service.js';
function reviewerOrgId(ctx) {
    const orgId = ctx.user?.orgId;
    if (!orgId)
        throw new Error('Authentication required.');
    return orgId;
}
function optionalReviewerOrgId(ctx) {

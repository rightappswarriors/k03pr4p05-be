...
export const InventoryItemUnitQuery = extendType({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field("inventoryItemUnits", {
            ...
            resolve: (_root, { inventoryItemId }, ctx) => ctx.prisma.inventoryItemUnit.findMany({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field("addInventoryItemUnits", {
            ...
            resolve: async (_root, { inventoryItemId, units }, ctx) => {
                ...
                return ctx.prisma.$transaction(units.map((u) => ctx.prisma.inventoryItemUnit.create({
                    data: {
                        inventoryItemId,
                        unitName: u.unitName,
        ...
        t.nonNull.field("deactivateInventoryItemUnit", {
            ...
            resolve: (_root, { id }, ctx) => ctx.prisma.inventoryItemUnit.update({
                where: { id },
                data: { isActive: false },
            }),
        });

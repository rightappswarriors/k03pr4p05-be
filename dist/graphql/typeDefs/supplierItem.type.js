...
export const SupplierItem = objectType({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field('variantGroups', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariantGroup.findMany({
                where: { supplierItemId: parent.id },
        ...
        t.nonNull.list.nonNull.field('variants', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariant.findMany({
                where: { supplierItemId: parent.id, deletedAt: null },
        ...
        t.nullable.field('marketplaceListing', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.marketplaceListing.findUnique({ where: { supplierItemId: parent.id } }),
        });
        // Wholesale product extensions
        t.nullable.field('productWholesaleSettings', {
            type: 'ProductWholesaleSettings',
            resolve: (parent, _, ctx) => ctx.prisma.productWholesaleSettings.findUnique({
                where: { supplierItemId: parent.id },
            }),
        });
        t.nonNull.list.nonNull.field('productSpecifications', {
            type: 'ProductSpecification',
            resolve: (parent, _, ctx) => ctx.prisma.productSpecification.findMany({
                where: { supplierItemId: parent.id, deletedAt: null },
                orderBy: { sortOrder: 'asc' },
            }),
        });
        t.nullable.field('wholesalePackaging', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.wholesalePackaging.findUnique({
                where: { supplierItemId: parent.id },
            }),
        });
        t.nullable.field('wholesaleShipping', {
            type: 'WholesaleShipping',
            resolve: (parent, _, ctx) => ctx.prisma.wholesaleShipping.findUnique({
                where: { supplierItemId: parent.id },
            }),
        });
...
export const SupplierItemVariantGroup = objectType({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field('options', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariantOption.findMany({
...
export const SupplierItemVariantValue = objectType({
    ...
    definition(t) {
        ...
        t.nonNull.field('option', {
            type: 'SupplierItemVariantOption',
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariantOption.findUniqueOrThrow({ where: { id: parent.optionId } }),
        });
    },
});
export const SupplierItemVariant = objectType({
    ...
    definition(t) {
        ...
        t.nonNull.list.nonNull.field('variantValues', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariantValue.findMany({
        ...
        t.nonNull.list.nonNull.field('images', {
            ...
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariantImage.findMany({
...
export const SupplierItemImage = objectType({
    ...
    definition(t) {
        ...
        t.nullable.field('supplierItem', {
            type: 'SupplierItem',
            resolve: (parent, _, ctx) => ctx.prisma.supplierItem.findUnique({ where: { id: parent.supplierItemId } }),
        });
    },
});
export const SupplierItemVariantImage = objectType({
    ...
    definition(t) {
        ...
        t.nullable.field('supplierItemVariant', {
            type: 'SupplierItemVariant',
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemVariant.findUnique({ where: { id: parent.supplierItemVariantId } }),
        });
    },
});
export const SupplierItemReviewImage = objectType({
    ...
    definition(t) {
        ...
        t.nullable.field('supplierItemReview', {
            type: 'SupplierItemReview',
            resolve: (parent, _, ctx) => ctx.prisma.supplierItemReview.findUnique({ where: { id: parent.supplierItemReviewId } }),
        });
    },
});

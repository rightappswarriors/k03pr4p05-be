...
export async function createOrganization(userId, name, roles = ['SELLER']) {
    try {
        ...
        throw new Error(error instanceof Error ? `Organization error: ${error.message}` : 'Failed to create organization');
    }
}
